...
public class LoginPage extends DriverFactory {
    ...
    public void registrausuario() {
        esperarElemento().until(ExpectedConditions.visibilityOfElementLocated(MobileBy.id("textInputEditTextName"))).sendKeys("Araceli Daniel");
        pegaDriver().findElement(MobileBy.id("textInputEditTextEmail")).sendKeys("araceli@teste.com");
    ...
    public void loginnovousuario() {
        esperarElemento().until(ExpectedConditions.visibilityOfElementLocated(MobileBy.id("textInputEditTextEmail"))).sendKeys("araceli@teste.com");
        pegaDriver().findElement(MobileBy.id("textInputEditTextPassword")).sendKeys("123456");
