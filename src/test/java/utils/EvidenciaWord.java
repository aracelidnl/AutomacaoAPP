...
public class EvidenciaWord extends DriverFactory {
    ...
    public void inserirConteudoCabecalho() throws IOException, InvalidFormatException {
        ...
        FileInputStream LogoProjeto = new FileInputStream("src/main/resources/support/logoProjeto.png");
        run.addPicture(LogoProjeto, XWPFDocument.PICTURE_TYPE_PNG, "logoProjeto", Units.toEMU(100), Units.toEMU(80));
    }
