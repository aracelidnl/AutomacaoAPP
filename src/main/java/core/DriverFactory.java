...
public class DriverFactory {
    ...
    public DesiredCapabilities configuracaoEmulador(){
        ...
        capabilities.setCapability(MobileCapabilityType.APP, "D:/Projetos github/AutomacaoAPP/AppLoginSample.apk");
        return capabilities;
    }
    public void iniciarDriver(){
        try {
            driver = new AppiumDriver<MobileElement>(new URL("http://127.0.1:4723/wd/hub"), configuracaoEmulador());
